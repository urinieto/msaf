...
hold on; plot([0:0.01:15],cvv(1:1501)); hold off
axis([10 14 -1 5])
print -adobecset -depsc bragg-onsetenv-10-14.eps
freqz([1 -1],[1 -.99])
0.003*pi
0.003*125
b = beat(d,sr,0,0,[10 14]);
ls
help coverFtrExLists
help calclistftrs
calclistftrs('../covers/all.list', '../covers
calclistftrs('../covers/all.list', '../covers/','','../cache/','');
qfiles=listfileread('../cache/query.txt');
ls ../cache
all = listfileread('all.list');
all(1)
all{1}
string(all{1})
isstring(all{1})
ischar(all{1})
ischar(all)
[R,S,T] = coverTestLists(all(1:5));
R
S
T
q = calclistftrs('shortmp3list.txt');
q
q{1}
[R,S,T] = coverTestLists(q);
R
size(all)
all{1}
all{2}
...
qlist = all(1:2:32);
tlist = all(2:2:32);
[R,S,T] = coverTestLists(qlist,tlist);
size(R)
R
[vv,xx] = max(R');
R == 1:16
...
subplot(412)
imgsc(styx.F)
r = chromxcorr(chromnorm(reo.F),chromnorm(styx.F));
size(r)
subplot(413)
r = chromxcorr(chromnorm(reo.F),chromnorm(styx.F),800);
size(r)
r = chromxcorr(chromnorm(reo.F),chromnorm(styx.F),600);
imgsc(r)
subplot(414)
plot(r(1,:))
plot([0:1600],r(1,:),[0:1600],filter([1 -1],[1 -.9],r(1,:))
plot([0:1600],r(1,:),[0:1600],filter([1 -1],[1 -.9],r(1,:)))
size(r(1,:))
plot([0:1200],r(1,:),[0:1200],filter([1 -1],[1 -.9],r(1,:)))
diag(R)
qlist{16}
tlist{16}
fmc=load(qlist{16})
scw = load(tlist{16})
r = chromxcorr(chromnorm(chrompwr(fmc.F,.5)),chromnorm(chrompwr(scw.F,.5)),1100);
subplot(411)
imgsc(fmc.F)
subplot(412)
imgsc(scw.F)
...
imgsc(r(:,500+[1:1200]))
subplot(414)
plot([0:2200],r(1,:),[0:2200],filter([1 -1],[1 -.9],r(1,:)))
plot(filter([1 -1],[1 -.9],r(1,:)))
plot(filter([1 -1],[1 -.9],r(1,500+[1:1200])))
fr1 = filter([1 -1],[1 -.9], r(1:,));
fr1 = filter([1 -1],[1 -.9], r(1,:));
plot(fr1(500+[1:1200])))
plot(fr1(500+[1:1200]))
[R,S,T,C] = coverTestLists(qlist,tlist);
C
T
R
S
...
qd = load(qlist{2})
td = load(tlist{2})
r = chromxcorr(chromnorm(chrompwr(qd.F,.5)),chromnorm(chrompwr(td.F,.5)),1100);
subplot(411)
imgsc(qd.F)
subplot(412)
imgsc(td.F)
...
imgsc(r(:,500+[1:1200]))
subplot(414)
fr1 = filter([1 -1],[1 -.9], r(3,:));
plot(fr1(500+[1:1200]))
fr1 = filter([1 -1],[1 -.9], r(2,:));
plot(fr1(500+[1:1200]))
plot(r(3,500+[1:1200]))
fr1 = filter([1 -1],[1 -.9], r(3,:));
subplot(411)
imgsc(fmc.F)
subplot(412)
scwF = chromrot(scw.F,3);
cd ..
scwF = chromrot(scw.F,3);
cd dist
imgsc(scwF)
scwF = chromrot(scw.F,-2);
cd ..
scwF = chromrot(scw.F,-2);
imgsc(scwF)
cd dist
r = chromxcorr(chromnorm(chrompwr(fmc.F,.5)),chromnorm(chrompwr(scwF,.5)),1100);
subplot(413)
imgsc(r)
imgsc(r(:,500+[1:1200]))
subplot(414)
...
plot(r(3,500+[1:1200]))
plot(fr1(500+[1:1200]))
plot([-600:600],fr1(500+[0:1200]))
subplot(413)
imgsc([-600:600],r(:,500+[0:1200]))
imgsc([-600:600],[1:12],r(:,500+[0:1200]))
print -adobecset -depsc golddustwomanxcorr.eps
gcolor
print -adobecset -depsc golddustwomanxcorr-bw.eps
colormap('default')
subplot(413)
imgsc([-600:600],[-5:6],chromrot(r(:,500+[0:1200]),-5))
median(diff(fmc.bts))
60/median(diff(fmc.bts))
60/median(diff(scw.bts))
