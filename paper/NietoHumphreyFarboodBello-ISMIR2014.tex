...
\subsection{Rank Stability Introduction and Stability of the Big Dataset}
...
TODO: Eric: Include the tags figure
...
TODO: Eric: Add the figure about the ranking of the algorithms depending on GT.
...
Section 3:
- Small dataset in here (how we create it)
- ``data set sorting''
- Getting annotations
