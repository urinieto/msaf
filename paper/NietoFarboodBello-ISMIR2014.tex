...
In our case, we use $K=250$ and a range of $\pm5$ seconds in order to capture the higher errors that manifest in the boundary identification task compared to beat tracking.
