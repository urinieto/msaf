...
def process(
    ...
    results_file = "results_sweep_boundsE{}_labelsE{}.csv".format(
    ...
    if labels_id == "cnmf3" or boundaries_id == "cnmf3":
        ...
        logging.error("Can't sweep parameters for %s algorithm. " "Implement me! :D")


def main():
    """Main function to sweep parameters of a certain algorithm."""
    parser = argparse.ArgumentParser(
        description="Runs the specified algorithm(s) on the MSAF " "formatted dataset.",
    ...
    parser.add_argument(
        ...
        dest="boundaries_id",
        default="gt",
        choices=["gt"] + io.get_all_boundary_algorithms(),
    )
    parser.add_argument(
        "-lid",
        action="store",
