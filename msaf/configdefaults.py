...
AddConfigVar(
    "default_bound_id",
    "Default boundary detection algorithm",
    EnumStr("sf", "cnmf", "foote", "olda", "scluster", "gt", "cbm"),
)
AddConfigVar(
    "default_label_id",
    "Default label detection algorithm",
...
# Files and dirs
AddConfigVar("results_dir", "Default directory to store results.", StrParam("results"))
AddConfigVar("results_ext", "Default extension for the results file.", StrParam(".csv"))
AddConfigVar(
    "out_boundaries_ext",
    "Default extension for output audio " "bounds.",
    StrParam("-bounds.wav"),
)
AddConfigVar(
    "minimum_frames",
...
AddConfigVar(
    "features_tmp_file",
    "Default temporary file for features.",
    StrParam(".features_msaf_tmp.json"),
)

# Dataset files and dirs
AddConfigVar("dataset.audio_dir", "Default audio directory.", StrParam("audio"))
AddConfigVar(
    "dataset.estimations_dir", "Default estimations directory.", StrParam("estimations")
)
AddConfigVar(
    "dataset.features_dir", "Default features directory.", StrParam("features")
)
AddConfigVar(
    "dataset.references_dir", "Default references directory.", StrParam("references")
)
AddConfigVar(
    "dataset.audio_exts", "Available audio files.", ListParam([".wav", ".mp3", ".aif"])
)
AddConfigVar(
    "dataset.estimations_ext", "Extension for the estimation files.", StrParam(".jams")
)
AddConfigVar(
    "dataset.features_ext", "Extension for the features files.", StrParam(".json")
)
AddConfigVar(
    "dataset.references_ext", "Extension for the reference files.", StrParam(".jams")
)


# CQT Features
AddConfigVar("cqt.bins", "Number of frequency bins for the CQT features.", IntParam(84))
AddConfigVar(
    "cqt.norm",
...
# PCP Features
AddConfigVar("pcp.bins", "Number of frequency bins for the CQT.", IntParam(84))
...
# Tonnetz Features
AddConfigVar("tonnetz.bins", "Number of frequency bins for the CQT.", IntParam(84))
...
# Tempogram Features
AddConfigVar(
    "tempogram.win_length", "The size of the window of the tempogram.", IntParam(192)
)
