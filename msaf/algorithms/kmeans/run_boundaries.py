#!/usr/bin/env python
'''Runs the k-means segmenter for boundaries across the Segmentation dataset
...
def process(in_path, annot_beats=False, feature="mfcc", ds_name="*"):
    ...
    for audio_file, jam_file in zip(audio_files, jam_files):
        ...
        MSAF.save_estimations(out_file, est_times, annot_beats, "kmeans",
                             feature=feature)
...
def main():
    ...
    parser = argparse.ArgumentParser(description=
        "Runs the k-means segmenter across a the Segmentation dataset and "
